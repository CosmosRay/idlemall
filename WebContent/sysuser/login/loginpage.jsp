...
<header>
    <section>
        <a href="<%=basePath %>commodity/index.html"><img src="<%=basePath %>images/logo/loginlogo.jpg" alt="图片无法显示"/></a>
        <div id="div1">
            <ul>
...
<!--登录界面设置-->
<section id="sec1">
    <div id="div3"><a href="<%=basePath %>commodity/index.html"><img src="<%=basePath %>images/logo/loginlogo_1.jpg"/></a></div>
    <div id="div4">
