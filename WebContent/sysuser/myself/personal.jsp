...
<section id="personal_sec1">
    ...
    <ul>
        ...
        <li><a style="text-decoration:none;color:orange;" href="<%=basePath %>sysUserAction/editOwn.action">修改个人信息</a>&nbsp;&nbsp;&nbsp;<a style="text-decoration:none;color:orange;" href="<%=basePath %>sysUserAction/editPwd.action">修改密码</a></li>
    </ul>
</section>
