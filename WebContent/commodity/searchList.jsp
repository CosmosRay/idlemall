...
<header>
    <nav id="nav1">
        <ul>
            <li id="nav_l1"><img src="../images/logo/address.png"><a href="#">送货地址，请选择？</a></li>
            <p id="nav_l0">&nbsp;</p>
...
<!--======================检索导航==========================-->
<section id="sec2">
    <div><img src="../images/logo/ViewGallery.png"/><a href="#">全部结果</a></div>
    <!--<div>&lt;!&ndash;<input type="text"><a href=""><p><img src="../images/logo/wxbsearch.png"></p></a>&ndash;&gt;</div>-->
...
<!--<section id="sec3">
    <div id="sec3_div1"><div>品牌</div>
        <span>
        <a href=""><img src="../images/logo/secrch_01.jpg"/></a>
        <a href=""><img src="../images/logo/secrch_02.jpg"/></a>
        <a href=""><img src="../images/logo/secrch_03.jpg"/></a>
        <a href=""><img src="../images/logo/secrch_04.jpg"/></a>
        <a href=""><img src="../images/logo/secrch_05.jpg"/></a>
        <a href=""><img src="../images/logo/secrch_06.jpg"/></a>
        <a href=""><img src="../images/logo/secrch_07.jpg"/></a>
        <a href=""><img src="../images/logo/secrch_08.jpg"/></a>
        <a href=""><img src="../images/logo/secrch_09.jpg"/></a>
        <a href=""><img src="../images/logo/secrch_10.jpg"/></a>
        <a href=""><img src="../images/logo/secrch_11.jpg"/></a>
        </span>
    </div>
...
<section id="sec4">
    <ul id="sec4_ul1">
        <li><a href="">综合</a></li>
        <li><a href="">销量<img src="../images/logo/more_unfold.png"/></a></li>
        <li><a href="">评论<img src="../images/logo/more_unfold.png"/></a></li>
        <li><a href="">新品<img src="../images/logo/more_unfold.png"/></a></li>
        <li><a href="">价格<img src="../images/logo/sx.png"/></a></li>
        <li class="sec4_li1"><a href=""><img src="../images/logo/more.png"></a></li>
        <li class="sec4_li1"><a href=""><img src="../images/logo/back.png"></a></li>
        <!--<li class="sec4_li1"><a href=""><img src="../images/logo/all(1).png">大图</a></li>
        <li class="sec4_li1"><a href=""><img src="../images/logo/wxbmxdp.png">店铺</a></li>-->
    </ul>
        <!--<div id="sec4_div1">
            <p>
...
<section id="sec6">
    <ul>
        <li id="sec6_li3" class="sec6_li"><a href="">下一页<img src="../images/logo/yjt.png"/></a></li>
