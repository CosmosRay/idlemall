$(function(){
    ...
    $(".AccountManagement").click(function(){
        $(".AccountManagement_c_iframe iframe").attr("src","../admin/AccountManagement.jsp")
    });
    $(".ColumnManagement").click(function(){
        $(".AccountManagement_c_iframe iframe").attr("src","../admin/ColumnManagement.jsp")
    });
    $(".NewsManagement").click(function(){
        $(".AccountManagement_c_iframe iframe").attr("src","../admin/NewsManagement.jsp")
    });
	...
	$(".nav_side>div").click(function(){
        ...
        if( index == 0 ){
            $(".user_location span").text("admin管理");
        }else if( index == 1){
